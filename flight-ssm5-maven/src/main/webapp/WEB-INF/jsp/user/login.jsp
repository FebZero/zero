...
<html lang="en">
	<head>
		...
		<!--[if IE 7]>
		  <link rel="stylesheet" href="${p}/assets/css/font-awesome-ie7.min.css" />
		<![endif]-->
		...
		<script type="text/javascript">
			window.jQuery || document.write("<script src='${p}/assets/js/jquery-2.0.3.min.js'>"+"<"+"/script>");
		</script>
...
<![endif]-->
		...
		<script type="text/javascript">
			if("ontouchend" in document) document.write("<script src='${p}/assets/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");
		</script>
	...
	<script type="text/javascript" src="${p}/assets/js/jquery.cookie.js"></script>
    <script type="text/javascript">
    $(function(){
    	$("#username").val($.cookie("username-cookie"));
    	$("#password").val($.cookie("password-cookie"));
    })
    </script>
	</head>
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">LZX</span>
									<span class="white">航空订票系统</span>
								</h1>
								<h4 class="blue">&copy; 良知行</h4>
							</div>
										...
										<div class="widget-main">
											...
											<form action="${p}/user/login" method="post">
												<fieldset>
													...
													<div class="clearfix">
														<label class="inline">
															<input type="checkbox" class="ace" name="save2cookie" value="yes"/>
											...
											<div class="social-or-login center">
												...
												<span class="bigger-110 red">${info}</span>
											</div>
<!-- 
